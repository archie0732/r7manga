  ...
  `,
  {
    variants: {
      variant: {
        ...
        destructive:
          `
            destructive group text-destructive-foreground border-destructive
            bg-destructive
          `,
      },
    },
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      `
        absolute top-1 right-1 rounded-md p-1 text-foreground/50 opacity-0
        transition-opacity
        group-hover:opacity-100
        group-[.destructive]:text-red-300
        hover:text-foreground hover:group-[.destructive]:text-red-50
        focus:opacity-100 focus:ring-1 focus:outline-hidden
